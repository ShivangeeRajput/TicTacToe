...
public class TicTacBoard extends View {
    ...
    public TicTacBoard(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            diagonalColor = a.getInteger(R.styleable.TicTacBoard_WinningLineColor, 0);
    ...
    public void setUpGame(Button playAgainButton, Button homeButton, TextView playerDisplay, String[] playerNames) {
